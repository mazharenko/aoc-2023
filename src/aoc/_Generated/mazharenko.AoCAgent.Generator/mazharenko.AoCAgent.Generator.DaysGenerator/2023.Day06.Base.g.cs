...
namespace aoc.Day06
{
	...
	partial class Day06
	{
		...
		{
			int Solve(global::Microsoft.FSharp.Collections.FSharpList<global::System.Tuple<long, long>> input);
			global::Microsoft.FSharp.Collections.FSharpList<global::System.Tuple<long, long>> Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day06.Day06.Part1 part = new aoc.Day06.Day06.Part1();
				public int Run()
				{
		...
		{
			long Solve(global::Microsoft.FSharp.Collections.FSharpList<global::System.Tuple<long, long>> input);
			global::Microsoft.FSharp.Collections.FSharpList<global::System.Tuple<long, long>> Parse(string input);
		}
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day06.Day06.Part2 part = new aoc.Day06.Day06.Part2();
				public long Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
