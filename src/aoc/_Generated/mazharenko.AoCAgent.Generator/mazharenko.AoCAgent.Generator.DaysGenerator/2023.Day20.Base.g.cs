...
namespace aoc.Day20
{
	...
	partial class Day20
	{
		...
		{
			long Solve(global::Microsoft.FSharp.Collections.FSharpMap<string, global::impl.day20.Module> input);
			global::Microsoft.FSharp.Collections.FSharpMap<string, global::impl.day20.Module> Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, long Expectation) : IExample<long>
			{
				...
				private static global::aoc.Day20.Day20.Part1 part = new aoc.Day20.Day20.Part1();
				public long Run()
				{
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day20.Day20.Part2 part = new aoc.Day20.Day20.Part2();
				public long Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
