	...
	partial class Day15
	{
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day15.Day15.Part1 part = new aoc.Day15.Day15.Part1();
				public int Run()
				{
		...
		{
			int Solve(global::impl.day15.Part2.Operation[] input);
			global::impl.day15.Part2.Operation[] Parse(string input);
		}
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day15.Day15.Part2 part = new aoc.Day15.Day15.Part2();
				public int Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
