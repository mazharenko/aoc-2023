...
namespace aoc.Day18
{
	...
	partial class Day18
	{
		...
		{
			int Solve(global::common.Point<long>[] input);
			global::common.Point<long>[] Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day18.Day18.Part1 part = new aoc.Day18.Day18.Part1();
				public int Run()
				{
		...
		{
			long Solve(global::common.Point<long>[] input);
			global::common.Point<long>[] Parse(string input);
		}
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day18.Day18.Part2 part = new aoc.Day18.Day18.Part2();
				public long Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
