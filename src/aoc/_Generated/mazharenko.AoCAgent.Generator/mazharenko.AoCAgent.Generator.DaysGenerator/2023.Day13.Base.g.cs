	...
	partial class Day13
	{
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			public System.Collections.Generic.IEnumerable<NamedExample> GetExamples()
			{
				...
				yield return new NamedExample("narrowBottom", new ExampleAdapter<int>(narrowBottom));
				yield return new NamedExample("narrowTop", new ExampleAdapter<int>(narrowTop));
				yield return new NamedExample("narrowRight", new ExampleAdapter<int>(narrowRight));
				yield return new NamedExample("narrowLeft", new ExampleAdapter<int>(narrowLeft));
			}
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day13.Day13.Part1 part = new aoc.Day13.Day13.Part1();
				public int Run()
				{
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day13.Day13.Part2 part = new aoc.Day13.Day13.Part2();
				public int Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
