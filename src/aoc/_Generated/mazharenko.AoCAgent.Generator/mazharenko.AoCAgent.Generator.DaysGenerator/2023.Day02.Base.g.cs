...
namespace aoc.Day02
{
	...
	partial class Day02
	{
		...
		{
			int Solve(global::impl.day02.Game[] input);
			global::impl.day02.Game[] Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day02.Day02.Part1 part = new aoc.Day02.Day02.Part1();
				public int Run()
				{
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day02.Day02.Part2 part = new aoc.Day02.Day02.Part2();
				public int Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
