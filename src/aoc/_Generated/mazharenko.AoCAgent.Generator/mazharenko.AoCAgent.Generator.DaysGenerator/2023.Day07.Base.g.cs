...
namespace aoc.Day07
{
	...
	partial class Day07
	{
		...
		{
			int Solve(global::System.Tuple<global::impl.day07.Part1.Hand, int>[] input);
			global::System.Tuple<global::impl.day07.Part1.Hand, int>[] Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day07.Day07.Part1 part = new aoc.Day07.Day07.Part1();
				public int Run()
				{
		...
		{
			int Solve(global::System.Tuple<global::impl.day07.Part2.Hand, int>[] input);
			global::System.Tuple<global::impl.day07.Part2.Hand, int>[] Parse(string input);
		}
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day07.Day07.Part2 part = new aoc.Day07.Day07.Part2();
				public int Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
