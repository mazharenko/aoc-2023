...
namespace aoc.Day12
{
	...
	partial class Day12
	{
		...
		{
			long Solve(global::System.Tuple<string, int[]>[] input);
			global::System.Tuple<string, int[]>[] Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			public System.Collections.Generic.IEnumerable<NamedExample> GetExamples()
			{
				...
				yield return new NamedExample("example1", new ExampleAdapter<long>(example1));
			}
			...
			private record Example(string Input, long Expectation) : IExample<long>
			{
				...
				private static global::aoc.Day12.Day12.Part1 part = new aoc.Day12.Day12.Part1();
				public long Run()
				{
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				yield return new NamedExample("example1", new ExampleAdapter<long>(example1));
				yield return new NamedExample("example2", new ExampleAdapter<long>(example2));
				yield return new NamedExample("example3", new ExampleAdapter<long>(example3));
				yield return new NamedExample("example5", new ExampleAdapter<long>(example5));
				yield return new NamedExample("example6", new ExampleAdapter<long>(example6));
				yield return new NamedExample("example7", new ExampleAdapter<long>(example7));
			}
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day12.Day12.Part2 part = new aoc.Day12.Day12.Part2();
				public long Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
