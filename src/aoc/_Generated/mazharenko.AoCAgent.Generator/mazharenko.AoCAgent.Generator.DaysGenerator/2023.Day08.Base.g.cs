...
namespace aoc.Day08
{
	...
	partial class Day08
	{
		...
		{
			int Solve(global::System.Tuple<global::impl.day08.Direction[], global::Microsoft.FSharp.Collections.FSharpMap<string, global::System.Tuple<string, string>>> input);
			global::System.Tuple<global::impl.day08.Direction[], global::Microsoft.FSharp.Collections.FSharpMap<string, global::System.Tuple<string, string>>> Parse(string input);
		}
		...
		partial class Part1 : Part1Base, IPart1
		{
			...
			public System.Collections.Generic.IEnumerable<NamedExample> GetExamples()
			{
				...
				yield return new NamedExample("repeatInstructions", new ExampleAdapter<int>(repeatInstructions));
			}
			...
			private record Example(string Input, int Expectation) : IExample<int>
			{
				...
				private static global::aoc.Day08.Day08.Part1 part = new aoc.Day08.Day08.Part1();
				public int Run()
				{
		...
		{
			long Solve(global::System.Tuple<global::impl.day08.Direction[], global::Microsoft.FSharp.Collections.FSharpMap<string, global::System.Tuple<string, string>>> input);
			global::System.Tuple<global::impl.day08.Direction[], global::Microsoft.FSharp.Collections.FSharpMap<string, global::System.Tuple<string, string>>> Parse(string input);
		}
		...
		partial class Part2 : Part2Base, IPart2
		{
			...
			{
				private string expectationFormatted = null !;
				private static global::aoc.Day08.Day08.Part2 part = new aoc.Day08.Day08.Part2();
				public long Run()
				{
					var parsedInput = part.Parse(Input);
					return part.Solve(parsedInput);
